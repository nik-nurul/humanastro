...
<head>
  ...
  <script src="javascript/calibration_test2.js"></script>
</head>
        ...
        <!-- There will be no feedback button in tutorial test page and test pages -->
          ...
          <div id="explanationDiv" class="content_paragraph" style="margin-top:100px; margin-bottom:20px; display: block;">
              ...
              <p class="paragraph_font">
                  ...
                  Click the "Start Calibration" button to begin. A new window will pop up and the rest of the visualisation tests will happen there. <br/><br/>
                  The new window will be in full screen. Do not resize the window.<br/><br/><br/>
                  Good luck!
              </p><br/><br/>
          </div>
