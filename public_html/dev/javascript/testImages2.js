...
//function to show the "Take Tutorial Test" button
 function showTutorialBttn(){
    var startCali = document.getElementById("startCalibration").style.display = 'none';
    var startTuto = document.getElementById("startTutorial").style.display = 'block';
 }
...
function init(){
		...
		startCali.onclick = showTutorialBttn;
