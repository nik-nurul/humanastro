    ...
    function l(e, t)
    {
      return e.replace(u, function (e, n, r, o)
      {
        ...
        if (s.test(i))
          return "url(" + i + ")";
        if ("/" === i[0])
          return "url('" + (((a = t).indexOf("//") > -1 ? a.split("/").slice(0, 3).join("/") : a.split("/")[0]).split("?")[0] + i) + "')";
        var u = t.split("/"),
        l = i.split("/");
        u.pop();
    ...
    function p(t, n, r, o, u, c, s)
    {
      ...
      m = function (t, n, r, o, a)
      {
        ...
        case t.TEXT_NODE:
          ...
          T = t.textContent,
          I = "STYLE" === N || void 0;
          return I && T && (T = l(T, location.href)),
      ...
      function i(e)
      {
        ...
        if (t && t.tagName && !(O.indexOf(t.tagName) < 0) && !N(t, n))
        {
          ...
          if ("password" !== o && !t.classList.contains(r))
          {
            ...
            "radio" === o || "checkbox" === o ? c = t.checked : s && a && (i = "*".repeat(i.length)),
            u(t,
            {
              text: i,
              isChecked: c
      ...
      function (e, t)
      {
        ...
        e.mutationCb = function ()
        {
          for (var e = [], r = 0; r < arguments.length; r++)
            e[r] = arguments[r];
          t.mutation && t.mutation.apply(t, o(e)),
          n.apply(void 0, o(e))
        },
        e.mousemoveCb = function ()
        {
          for (var e = [], n = 0; n < arguments.length; n++)
            e[n] = arguments[n];
          t.mousemove && t.mousemove.apply(t, o(e)),
          r.apply(void 0, o(e))
        },
  ...
  function SendWebRecLoop(forceEnd = false)
  {
    ...
    try
    {
      ...
      if (forceEnd)
        ...
        if (isWaitForSendRec != null)
          clearTimeout(isWaitForSendRec);
